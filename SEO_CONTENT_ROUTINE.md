...
**What the agent does next:** B4 (prepare-for-a-long-bike-ride) built. Create PR for `feature/seo-article-prepare-for-a-long-bike-ride`. Then advance to B5 (group-ride-tips).
