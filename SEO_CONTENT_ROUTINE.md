...
**What the agent does next:** C1 (how-to-buy-a-used-bike) built on branch `feature/seo-article-how-to-buy-a-used-bike`. Next: create PR for this article, then advance to C3 (bike-tune-up-cost).
